...
namespace MetaComp
{
    public partial class MZmine_Input : Form
    {
        public MZmine_Input()
        {
            InitializeComponent();
            ...
            for (int i = 0; i < filePath.Length - 1; i++)
            {
                ...
                while ((strLine = sr.ReadLine()) != null)
                {
                    ...
                    else
                    {
                        ...
                        if (aryLine[9].Length != 0)
                        {
                            if (dt.Rows.Count == 0)
                            {
                                if (aryLine[9].Contains(";"))
                                {
                                    string[] subject_ID = aryLine[9].Replace("\"", "").Split(';');
                                    for (int k = 0; k < subject_ID.Length; k++)
                                    {

                                        DataRow dr = dt.NewRow();
                                        dr[0] = subject_ID[k].ToString();
                                        dr[1] = 1;
                                        dt.Rows.Add(dr);
                                ...
                                { 
                                    DataRow dr = dt.NewRow();
                                        dr[0] = aryLine[9].Replace("\"", "").ToString();
                                        dr[1] = 1;
                                        dt.Rows.Add(dr);
                                }
                            ...
                            else
                            {
                                if (aryLine[9].Contains(";"))
                                {
                                    ...
                                    for (int j = 0; j < subject_ID.Length; j++)
                                    {
                                        ...
                                        for (int k = 0; k < dt.Rows.Count; k++)
                                        {
                                            ...
                                            if (string.Equals(subject_ID[j], dt.Rows[k][0]))
                                            {
                                ...
                                else
                                {
                                    ...
                                    for (int k = 0; k < dt.Rows.Count; k++)
                                    {
                                        ...
                                        if (string.Equals(aryLine[9].Replace("\"", ""), dt.Rows[k][0]))
                                        {
                                            dt.Rows[k][1] = Convert.ToInt32(dt.Rows[k][1]) + 1;
                                            newFea = false;
                                            break;
